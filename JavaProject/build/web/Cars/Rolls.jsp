...
<link rel="stylesheet" href="css/styles.css" type="text/css" />
   ...
   <header> 
	<div class="width">
        ...
        <li class="selected">    <a href="../bookacar.jsp"><i class="fa fa-briefcase"></i> Car & Rates</a></li>
...
<section id="content" class="one-column">
	    ...
	    <article class="rig columns-3">
	
        	<center><a href="#"><img src="images/royce.jpeg"></a> <br>
        ...
        <a style="text-align: left; font-weight:bold;"> Year:</a> 2014 to 2015<br><br>
        ...
        <p>You can see the various model of Rolls Royce <a href="https://www.rolls-roycemotorcars.com/en-GB/home.html">From Here</a>.</p>
        <center> <span class="value">$100</span><span class="price">$550</span><br><br>
        ...
        <h3>For Renting a Car, Login First</h3>  
        <h6 style="margin-bottom: auto;"> <a href="../Customer/customerLogin.jsp"> Login </a> </h6>
